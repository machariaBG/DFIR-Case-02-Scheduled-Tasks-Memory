...
## 1. Executive Summary
During a threat-hunting sweep on a Windows 11 Pro host, an unauthorized persistence mechanism was identified leveraging the Windows Task Scheduler. The scheduled task was configured to run an obfuscated PowerShell script out of a user profile space to maintain persistence across reboots. 
